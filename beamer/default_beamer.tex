...
\setbeamerfont{author}{parent={title},size=\Large,family=\rmfamily}
...
\begin{mdframed}[tikzsetting={draw=black, fill=white, fill opacity=0.7, line width=4pt},
    ...
    leftmargin=0, rightmargin=0, skipabove=0.3\paperwidth, skipbelow=0.05\paperwidth,
